/**
 * EasyQRCodeJS / QRCode.js - Pure JavaScript QR Code Generator
 */
var QRCode;
(function () {
	...
	QRCode.prototype.makeCode = function (text) {
		...
		for (var t = 1; t <= 40; t++) {
			try {
				var model = new QRCodeModel(t, this._options.correctLevel);
				model.addData(text);
				model.make();
				qrCode = model;
				break;
		...
		var tileW = this._options.width / count;
		var tileH = this._options.height / count;
